...
/* harmony import */ var _modules_showMoreItems__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/showMoreItems */ "./src/js/modules/showMoreItems.js");
...
/* harmony import */ var _modules_filterTabs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/filterTabs */ "./src/js/modules/filterTabs.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_5__["default"])('.main-slider-item', 'vertical', '', '', loopSlidesSeconds);
  Object(_modules_sliders__WEBPACK_IMPORTED_MODULE_5__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn', loopSlidesSeconds);
  ...
  Object(_modules_showMoreItems__WEBPACK_IMPORTED_MODULE_4__["default"])('.button-styles', '#styles .grid-col');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', '.promocode', '.calc-price');
  Object(_modules_filterTabs__WEBPACK_IMPORTED_MODULE_7__["default"])();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
const accordion = accordionHeadingSelector => {
  const btns = document.querySelectorAll(accordionHeadingSelector);
  btns.forEach(btn => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
const dragAndDrop = fileInputSelectors => {
  const fileInputs = document.querySelectorAll(fileInputSelectors);
...
/* harmony default export */ __webpack_exports__["default"] = (dragAndDrop); // drag * 
// dragend *
// dragenter * - object over dropArea; 
// dragexit * 
// dragleave * - object outside dropArea;
// dragover * - object hovering over dropArea; 
// dragstart * - 
...
const forms = () => {
  const form = document.querySelectorAll('form'),
        ...
        uploadInputs = document.querySelectorAll('[name="upload"]'); // checkNumInputs('input[name="user_phone"');
...
/***/ "./src/js/modules/imagesChange.js":
/*!****************************************!*\
  !*** ./src/js/modules/imagesChange.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (imagesChange);
...
/***/ "./src/js/modules/showMoreItems.js":
/*!*****************************************!*\
  !*** ./src/js/modules/showMoreItems.js ***!
  \*****************************************/
/*! exports provided: default */
...
const showMoreItems = (triggerSelector, wrapper) => {
  ...
  btn.addEventListener('click', () => {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["getResources"])('http://localhost:3000/styles').then(res => createCard(res)).catch(error => console.log(error));
    btn.remove();
  });
};

/* harmony default export */ __webpack_exports__["default"] = (showMoreItems);
